...
const Index = () => {
  ...
  const [levels] = useState<Level[]>([
    {
      id: 1,
      title: 'Level 1: Learn SAR',
      planet: planetTeal,
      badge: 'Radar Explorer',
      glowColor: 'hsl(180 65% 50%)',
      progress: 100,
    },
    {
      id: 2,
      title: 'Level 2: Flood Expert',
      planet: planetCyan,
      badge: 'Flood Explorer',
      glowColor: 'hsl(190 80% 55%)',
      progress: 85,
    },
    {
      id: 3,
      title: 'Level 3: Safety Measures',
    ...
    {
      id: 6,
      title: 'Level 6: Guidelines to Survive Flood',
      planet: planetPink,
      badge: 'Protector',
      ...
      <div className='relative z-10 container mx-auto px-4 py-16'>
        <header className='text-center mb-20'>
          ...
          <p className='text-lg text-cosmic-cyan mt-2'>
            Complete each planet to earn your badges and become a Flood
            Guardian! 🏆
          </p>
        </header>
        ...
        <div className='relative space-y-8'>
          ...
          >
            ...
            <path
              d='M 85% 132% Q 65% 138%, 50% 144%'
              stroke='url(#pathGradient6)'
              strokeWidth='3'
              fill='none'
              strokeDasharray='10,5'
              className='animate-pulse'
