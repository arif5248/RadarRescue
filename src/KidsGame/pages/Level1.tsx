...
const Level1 = () => {
  ...
  const [stage, setStage] = useState<
    'intro' | 'video1' | 'video2' | 'video3' | 'quiz' | 'completion'
  >('intro')
  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-background via-cosmic-purple to-cosmic-teal/20 overflow-hidden relative'>
      ...
      {/* Orbiting Satellites */}
      <div
        className='absolute top-20 right-20 z-0 animate-orbit'
      ...
      >
        <div className='w-20 h-20 flex items-center justify-center'>
          <div className='relative'>
            {/* Satellite body */}
            <div
              className='w-12 h-8 bg-gradient-to-br from-cosmic-teal to-cosmic-cyan rounded-sm border-2 border-cosmic-teal shadow-lg'
              style={{
                boxShadow:
                  '0 0 20px hsl(180 65% 50%), 0 0 40px hsl(180 65% 50% / 0.5)',
              }}
            />
            {/* Solar panels */}
            ...
            {/* Antenna */}
            <div
              className='absolute top-0 left-1/2 -translate-x-1/2 -translate-y-full w-1 h-4 bg-cosmic-teal shadow-lg'
              style={{ boxShadow: '0 0 10px hsl(180 65% 50%)' }}
            />
            {/* Dish */}
      ...
      <div
        className='absolute bottom-40 left-20 z-0 animate-orbit'
      ...
      {/* Floating planets */}
      <div
        className='absolute top-32 left-32 w-16 h-16 bg-gradient-to-br from-cosmic-teal/40 to-cosmic-cyan/40 rounded-full blur-sm animate-float'
        style={{ animationDuration: '8s' }}
      />
      <div
        className='absolute bottom-32 right-32 w-24 h-24 bg-gradient-to-br from-cosmic-magenta/30 to-cosmic-purple/30 rounded-full blur-sm animate-float'
        style={{ animationDuration: '10s', animationDelay: '-2s' }}
      />
      <div
        className='absolute top-1/2 right-20 w-12 h-12 bg-gradient-to-br from-cosmic-cyan/40 to-cosmic-blue/40 rounded-full blur-sm animate-float'
        style={{ animationDuration: '7s', animationDelay: '-4s' }}
      />

      {/* Cosmic glow effects */}
      <div
        className='absolute top-1/4 left-1/4 w-64 h-64 bg-cosmic-teal/20 rounded-full blur-3xl animate-pulse'
        style={{ animationDuration: '4s' }}
      />
      <div
        className='absolute bottom-1/4 right-1/4 w-96 h-96 bg-cosmic-purple/20 rounded-full blur-3xl animate-pulse'
        ...
        {stage === 'intro' && (
          <div className='flex items-center justify-center min-h-screen animate-fade-in'>
            <Card className='p-12 bg-card/80 backdrop-blur-md border-cosmic-teal shadow-[0_0_40px_hsl(180_65%_50%/0.3)] max-w-2xl text-center'>
              <div className='mb-8'>
                <div className='inline-block text-8xl mb-4 animate-pulse'>
                  🌐
                </div>
              </div>
            ...
            <Card className='p-8 bg-card/90 backdrop-blur-md border-cosmic-teal shadow-[0_0_40px_hsl(180_65%_50%/0.3)] max-w-4xl'>
              ...
              <div className='relative aspect-video bg-gradient-to-br from-cosmic-purple to-cosmic-teal/20 rounded-lg mb-6 overflow-hidden border-2 border-cosmic-cyan shadow-[0_0_30px_hsl(190_80%_55%/0.4)]'>
                    ...
                    <div className='text-center w-full h-full flex flex-col items-center justify-center p-8'>
                      ...
                      <div className='space-y-4 text-lg text-foreground/90 max-w-2xl'>
                        <p className='animate-fade-in'>
                          🛰️ SAR stands for Synthetic Aperture Radar
                        </p>
                        <p
                          className='animate-fade-in'
                          style={{ animationDelay: '2s' }}
                        >
                          📡 It sends radio waves to Earth and measures the
                          reflection
                        </p>
                        <p
                          className='animate-fade-in'
                        ...
                        >
                          🌍 This creates detailed images of the Earth's surface
                        </p>
                        <p
                          className='animate-fade-in'
                ...
                <div className='absolute inset-0 pointer-events-none'>
                  ...
                  <div
                    className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 border-4 border-cosmic-cyan/20 rounded-full animate-ping'
            ...
            <Card className='p-8 bg-card/90 backdrop-blur-md border-cosmic-cyan shadow-[0_0_40px_hsl(190_80%_55%/0.3)] max-w-4xl'>
              ...
              <div className='relative aspect-video bg-gradient-to-br from-cosmic-blue to-cosmic-cyan/20 rounded-lg mb-6 overflow-hidden border-2 border-cosmic-teal shadow-[0_0_30px_hsl(180_65%_50%/0.4)]'>
                <div className='absolute inset-0 flex items-center justify-center'>
                  {!videoPlaying ? (
                    ...
                    <div className='text-center w-full h-full flex flex-col items-center justify-center p-8'>
                      ...
                      <div className='space-y-4 text-lg text-foreground/90 max-w-2xl'>
                        <p className='animate-fade-in'>
                          ☁️ Unlike cameras, SAR can see through clouds
                        </p>
                        <p
                          className='animate-fade-in'
                          style={{ animationDelay: '2s' }}
                        >
                          🌙 It works perfectly at night without sunlight
                        </p>
                        <p
                          className='animate-fade-in'
                          style={{ animationDelay: '4s' }}
                        >
                          🌧️ Rain and fog don't block radar signals
                        </p>
                        <p
                          className='animate-fade-in'
                          style={{ animationDelay: '6s' }}
                        >
                          ✨ This makes it perfect for monitoring floods!
                        </p>
                      </div>
                    </div>
                  )}
                ...
                <div className='absolute inset-0 pointer-events-none'>
                  ...
                  <div
                    className='absolute top-1/3 right-1/4 w-32 h-32 bg-white/10 rounded-full blur-xl animate-float'
                    style={{ animationDelay: '1s' }}
                  />
                </div>
              </div>
                ...
                <div className='absolute inset-0 flex items-center justify-center'>
                  {!videoPlaying ? (
                    ...
                    <div className='text-center w-full h-full flex flex-col items-center justify-center p-8'>
                      ...
                      <div className='space-y-4 text-lg text-foreground/90 max-w-2xl'>
                        <p className='animate-fade-in'>
                          🌊 Water appears dark in radar images
                        </p>
                        <p
                          className='animate-fade-in'
                          style={{ animationDelay: '2s' }}
                        >
                          📊 Smooth surfaces reflect signals away from satellite
                        </p>
                        <p
                          className='animate-fade-in'
                          style={{ animationDelay: '4s' }}
                        >
                          🏘️ Buildings and land appear brighter
                        </p>
                        <p
                          className='animate-fade-in'
                          style={{ animationDelay: '6s' }}
                        >
                          🚨 This helps us spot floods quickly and save lives!
                        </p>
                      </div>
                    </div>
                  )}
            ...
            <Card className='p-12 bg-card/90 backdrop-blur-md border-cosmic-golden shadow-[0_0_60px_hsl(45_95%_60%/0.5)] max-w-2xl text-center'>
              <div className='mb-8 relative'>
                ...
                <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
                  <div
                    className='absolute w-2 h-2 bg-cosmic-golden rounded-full animate-ping'
                  ...
                  />
                  <div
                    className='absolute w-2 h-2 bg-cosmic-magenta rounded-full animate-ping'
              ...
              <p className='text-xl text-muted-foreground mb-8'>
                You've mastered SAR technology and earned your first badge!
                Planet 1 is now complete with a golden ring.
              </p>
              ...
              >
                Continue to Level 2: Flood Expert{' '}
