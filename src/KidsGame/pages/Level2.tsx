...
const Level2 = () => {
  ...
  const handleVillageClick = (villageId: number) => {
    ...
    if (
      newVillages.filter((v) => v.isFlooded && v.found).length ===
      newVillages.filter((v) => v.isFlooded).length
    ) {
      setTimeout(() => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-cosmic-cyan/20 via-cosmic-blue/30 to-cosmic-purple/20 overflow-hidden relative'>
      ...
      {/* Orbiting Satellites */}
      <div
        className='absolute top-32 right-32 z-0 animate-orbit'
      ...
      >
        <div className='w-20 h-20 flex items-center justify-center'>
          <div className='relative'>
            {/* Satellite body */}
            <div
              className='w-12 h-8 bg-gradient-to-br from-cosmic-cyan to-cosmic-blue rounded-sm border-2 border-cosmic-cyan shadow-lg'
              style={{
                boxShadow:
                  '0 0 20px hsl(190 80% 55%), 0 0 40px hsl(190 80% 55% / 0.5)',
              }}
            />
            {/* Solar panels */}
            ...
            {/* Antenna */}
            <div
              className='absolute top-0 left-1/2 -translate-x-1/2 -translate-y-full w-1 h-4 bg-cosmic-cyan shadow-lg'
              style={{ boxShadow: '0 0 10px hsl(190 80% 55%)' }}
            />
            {/* Dish */}
      ...
      <div
        className='absolute bottom-24 left-24 z-0 animate-orbit'
      ...
      >
        <div className='w-20 h-20 flex items-center justify-center'>
          <div className='relative'>
            {/* Satellite body */}
            <div
              className='w-12 h-8 bg-gradient-to-br from-cosmic-blue to-cosmic-teal rounded-sm border-2 border-cosmic-blue shadow-lg'
              style={{
                boxShadow:
                  '0 0 20px hsl(200 90% 60%), 0 0 40px hsl(200 90% 60% / 0.5)',
              }}
            />
            {/* Solar panels */}
            ...
            {/* Antenna */}
            <div
              className='absolute top-0 left-1/2 -translate-x-1/2 -translate-y-full w-1 h-4 bg-cosmic-blue shadow-lg'
              style={{ boxShadow: '0 0 10px hsl(200 90% 60%)' }}
            />
            {/* Dish */}
      ...
      {/* Floating planets */}
      <div
        className='absolute top-40 left-40 w-20 h-20 bg-gradient-to-br from-cosmic-cyan/40 to-cosmic-blue/40 rounded-full blur-sm animate-float'
        style={{ animationDuration: '9s' }}
      />
      <div
        className='absolute bottom-40 right-40 w-28 h-28 bg-gradient-to-br from-cosmic-blue/30 to-cosmic-cyan/30 rounded-full blur-sm animate-float'
        style={{ animationDuration: '11s', animationDelay: '-3s' }}
      />
      <div
        className='absolute top-1/3 right-24 w-16 h-16 bg-gradient-to-br from-cosmic-teal/40 to-cosmic-cyan/40 rounded-full blur-sm animate-float'
        style={{ animationDuration: '8s', animationDelay: '-5s' }}
      />

      {/* Cosmic glow effects */}
      <div
        className='absolute top-1/3 left-1/3 w-72 h-72 bg-cosmic-cyan/20 rounded-full blur-3xl animate-pulse'
        style={{ animationDuration: '4s' }}
      />
      <div
        className='absolute bottom-1/3 right-1/3 w-96 h-96 bg-cosmic-blue/20 rounded-full blur-3xl animate-pulse'
      ...
      <div className='absolute inset-0 pointer-events-none'>
        <div
          className='absolute top-1/4 left-1/4 w-64 h-64 border-4 border-cosmic-cyan/20 rounded-full animate-ping'
          style={{ animationDuration: '4s' }}
        />
        <div
          className='absolute top-1/2 right-1/4 w-96 h-96 border-4 border-cosmic-blue/20 rounded-full animate-ping'
          style={{ animationDuration: '5s', animationDelay: '1s' }}
        />
        <div
          className='absolute bottom-1/4 left-1/2 w-48 h-48 border-4 border-cosmic-cyan/20 rounded-full animate-ping'
            ...
            <Card className='p-8 bg-card/90 backdrop-blur-md border-cosmic-cyan shadow-[0_0_40px_hsl(190_80%_55%/0.3)] max-w-4xl'>
              ...
              <div className='relative aspect-video bg-gradient-to-br from-cosmic-cyan/20 to-cosmic-blue/20 rounded-lg mb-6 overflow-hidden border-2 border-cosmic-cyan shadow-[0_0_30px_hsl(190_80%_55%/0.4)]'>
                    ...
                    <div className='text-center w-full h-full flex flex-col items-center justify-center p-8 space-y-6'>
                      ...
                      <div className='space-y-4 text-lg text-foreground/90 max-w-2xl'>
                        <p className='animate-fade-in flex items-center gap-3 justify-center'>
                          <span className='text-3xl'>💧</span>A flood is when
                          water covers land that is usually dry
                        </p>
                        <p
                          className='animate-fade-in flex items-center gap-3 justify-center'
                          style={{ animationDelay: '2s' }}
                        >
                          <span className='text-3xl'>🏞️</span>
                          It happens when there's too much water in rivers and
                          streams
                        </p>
                        <p
                          className='animate-fade-in flex items-center gap-3 justify-center'
                ...
                <div className='absolute inset-0 pointer-events-none'>
                  ...
                  <div
                    className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-56 h-56 border-4 border-cosmic-blue/20 rounded-full animate-ping'
            ...
            <Card className='p-8 bg-card/90 backdrop-blur-md border-cosmic-blue shadow-[0_0_40px_hsl(200_90%_60%/0.3)] max-w-4xl w-full'>
                ...
                {villages.map((village) => (
                  ...
                  >
                    <div className='text-2xl'>
                      {village.found ? (village.isFlooded ? '✨' : '💚') : '🏘️'}
                    </div>
                  </button>
                ))}

                {/* Hint overlay */}
                {villages.filter((v) => v.isFlooded && v.found).length ===
                  0 && (
              ...
              <div className='text-center'>
                <p className='text-lg font-semibold text-cosmic-cyan'>
                  Found: {villages.filter((v) => v.isFlooded && v.found).length}{' '}
                  / {villages.filter((v) => v.isFlooded).length} flooded
                  villages
                </p>
              </div>
            </Card>
                ...
                <div className='grid gap-4'>
                  {quizAnswers[currentQuestion].options.map((option, index) => (
                    ...
                    >
                      ...
                      {option.text}
                      {quizAnswers[currentQuestion].answered &&
                        option.correct && <Check className='ml-auto w-6 h-6' />}
                      {quizAnswers[currentQuestion].answered &&
                        !option.correct && <X className='ml-auto w-6 h-6' />}
                    </Button>
                  ))}
                </div>
              </div>
          ...
          <div className='flex items-center justify-center min-h-screen animate-fade-in'>
            <Card className='p-12 bg-card/90 backdrop-blur-md border-cosmic-cyan shadow-[0_0_60px_hsl(190_80%_55%/0.5)] max-w-2xl text-center relative overflow-hidden'>
              ...
              <div className='absolute inset-0 pointer-events-none'>
                ...
                <div
                  className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 border-8 border-cosmic-cyan/20 rounded-full animate-ping'
                  style={{ animationDelay: '1s' }}
                />
              </div>
              ...
              <div className='relative z-10'>
                <div className='mb-8 relative'>
                  ...
                  <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
                    <div
                      className='absolute w-2 h-2 bg-cosmic-cyan rounded-full animate-ping'
                      style={{ top: '-40px', left: '0' }}
                    />
                    <div
                      className='absolute w-2 h-2 bg-cosmic-blue rounded-full animate-ping'
                      style={{
                        top: '-30px',
                        left: '30px',
                        animationDelay: '0.2s',
                    ...
                    <div
                      className='absolute w-2 h-2 bg-cosmic-cyan rounded-full animate-ping'
                      style={{ top: '0', left: '40px', animationDelay: '0.4s' }}
                    />
                    <div
                      className='absolute w-2 h-2 bg-cosmic-blue rounded-full animate-ping'
                      style={{
                    ...
                    <div
                      className='absolute w-2 h-2 bg-cosmic-cyan rounded-full animate-ping'
                      style={{ top: '40px', left: '0', animationDelay: '0.8s' }}
                    />
                  </div>
                </div>
                ...
                <p className='text-xl text-muted-foreground mb-8'>
                  You've learned about floods and earned your second badge!
                  Planet 2 now glows with a cyan water-ring.
                </p>

                <div className='bg-cosmic-cyan/10 border-2 border-cosmic-cyan rounded-lg p-6 mb-8'>
                  <p className='text-lg text-foreground'>
                    🌊 You now understand why floods happen and how to spot
                    them!
                  </p>
                </div>
                ...
                >
                  Continue to Level 3: Safety Measures{' '}
